...
Handles JWT token creation/verification and password hashing for secure authentication.
"""
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None) -> str:
    ...
    Args:
        data: Payload data to encode in token (e.g., {"sub": username})
...
def decode_access_token(token: str) -> Optional[str]:
    """
    Decode and verify JWT token, extract username
